...
OPTION[0]="--src=largestdegree --device=0,1,2,3 --traversal-mode=0 --v --partition-method=biasrandom --grid-size=768"
...
SUFFIX="ubuntu12.04.k40cx4_brp0.5_cq"
EXCUTION="./bin/test_bfs_7.5_x86_64"
